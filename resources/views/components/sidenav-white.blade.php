    ...
    <div class="container-fluid px-1">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto ms-xl-auto">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-3" aria-current="page" href="{{ route('beranda') }}">
                        ...
                        <div style="font-weight: bold; text-align: center; margin-top: 2px;">Beranda</div>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-3">
                        ...
                        <select class="form-select-no-border" style="font-weight: bold; text-align: center; margin-top: 2px; margin-left: -5px;" onchange="location = this.value;">
                            <option>Profil Desa</option>
                            <option value="{{ route('profil_desa') }}">Tentang Desa</option>
                            <option value="{{ route('visi_misi') }}">Visi & Misi</option>
                            <option value="{{ route('tugas_fungsi') }}">Tugas & Fungsi</option>
                            <option value="{{ route('struktur_organisasi') }}">Struktur Organisasi</option>
                        </select>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-3 " href="{{ route('pelayanan_publik') }}">
                        <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" class="opacity-6 me-1">
                            <path fill-rule="evenodd"
                        ...
                        <div style="font-weight: bold; text-align: center; margin-top: 2px;">Pelayanan Publik</div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-3">
                        ...
                        <select class="form-select-no-border" style="font-weight: bold; text-align: center; margin-top: 2px; margin-left: -10px;"
                            onchange="location = this.value;">
                            <option>Lain-lain</option>
                            <option value="{{ route('galeri') }}">Galeri</option>
                            <option value="{{ route('umkm') }}">UMKM</option>
                            <option value="{{ route('peta_wilayah') }}">Peta Wilayah</option>
                            <option value="{{ route('data') }}">Data</option>
                            <option value="{{ route('infografis') }}">Infografis</option>
                        </select>
