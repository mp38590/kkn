                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-15 col-md-15 text-center" style="margin-left: 20px; margin-top: 100px;">
                            ...
                            <div class="custom-text3" style="margin-left: -20px; margin-top: 35px;">Kegiatan Monodisiplin Silvani Ika Wulandari</div>
                            <div class="custom-text4" id="monodisiplin1" style="margin-left: -20px; margin-top: 5px;">Pembuatan “MOL” Sebagai Upaya Pengembangan Budidaya Ikan Lele Karang Taruna Desa Ngijo</div>
                        </div>
                        ...
                        <div class="col-xl-15 col-md-15 text-center" style="margin-left: 20px; margin-top: 20px;">
                            <div class="custom-text4" id="monodisiplin2" style="margin-left: -20px; margin-top: 5px;">Pelatihan Pembuatan Produk Olahan Ikan: Inovasi Makanan Sumber Gizi Bagi Anak</div>
                        </div>
                        <div class="d-flex justify-content-around" style="margin-left: 80px;">
                            <div class="d-block" style="margin-top: 30px; margin-left: -80px; margin-right: 30px;">
                                <img src="../assets/img/S7.JPG" alt="image 1" style="width: 300px; height: 180px;">
                            </div>

                            <div class="d-block" style="margin-top: 30px; margin-left: -50px; margin-right: 0px;">
                                <img src="../assets/img/S8.JPG" alt="image 2" style="width: 300px; height: 180px;">
                            </div>
