                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-7">
                                ...
                                <img src="../assets/img/logo.jpg" alt="Logo" class="rounded-circle position-absolute start-20 translate-middle-x"
                                ...
                                <div class="card-body">
                                <form role="form" class="text-start" method="POST" action="{{ route('login_layanan') }}">
                                    @csrf
